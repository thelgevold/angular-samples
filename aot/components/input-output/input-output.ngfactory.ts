...
var renderType_InputOutput_Host:import4.RenderComponentType = (null as any);
class _View_InputOutput_Host0 extends import3.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import5.AppElement;
  _InputOutput_0_4:Wrapper_InputOutput;
  ...
  createInternal(rootSelector:string):import5.AppElement {
    this._el_0 = import2.selectOrCreateRenderHostElement(this.renderer,'input-output',import2.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
    this._appEl_0 = new import5.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_InputOutput0(this.viewUtils,this.injector(0),this._appEl_0);
    this._InputOutput_0_4 = new Wrapper_InputOutput(new import8.ElementRef(this._el_0),(null as any));
    this._appEl_0.initComponent(this._InputOutput_0_4.context,([] as any[]),compView_0);
    compView_0.create(this._InputOutput_0_4.context,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.InputOutput) && (0 === requestNodeIndex))) { return this._InputOutput_0_4.context; }
...
function viewFactory_InputOutput_Host0(viewUtils:import2.ViewUtils,parentInjector:import6.Injector,declarationEl:import5.AppElement):import3.AppView<any> {
  if ((renderType_InputOutput_Host === (null as any))) { (renderType_InputOutput_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_InputOutput_Host0(viewUtils,parentInjector,declarationEl);
}
export const InputOutputNgFactory:import10.ComponentFactory<import0.InputOutput> = new import10.ComponentFactory<import0.InputOutput>('input-output',viewFactory_InputOutput_Host0,import0.InputOutput);
const styles_InputOutput:any[] = ([] as any[]);
var renderType_InputOutput:import4.RenderComponentType = (null as any);
class _View_InputOutput0 extends import3.AppView<import0.InputOutput> {
  _el_0:any;
  _text_1:any;
  _text_2:any;
  _el_3:any;
  ...
  createInternal(rootSelector:string):import5.AppElement {
    ...
    this._el_3 = import2.createRenderElement(this.renderer,parentRenderNode,'div',import2.EMPTY_INLINE_ARRAY,(null as any));
    this._text_4 = this.renderer.createText(this._el_3,'',(null as any));
    this._text_5 = this.renderer.createText(parentRenderNode,'\n              ',(null as any));
    this._el_6 = import2.createRenderElement(this.renderer,parentRenderNode,'div',import2.EMPTY_INLINE_ARRAY,(null as any));
    this._text_7 = this.renderer.createText(this._el_6,'',(null as any));
    this._text_8 = this.renderer.createText(parentRenderNode,'\n              ',(null as any));
    this._el_9 = import2.createRenderElement(this.renderer,parentRenderNode,'div',import2.EMPTY_INLINE_ARRAY,(null as any));
...
export function viewFactory_InputOutput0(viewUtils:import2.ViewUtils,parentInjector:import6.Injector,declarationEl:import5.AppElement):import3.AppView<import0.InputOutput> {
  if ((renderType_InputOutput === (null as any))) { (renderType_InputOutput = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,styles_InputOutput,{})); }
