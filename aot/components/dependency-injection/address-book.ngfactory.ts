...
var renderType_AddressBook_Host:import0.RenderComponentType = (null as any);
class _View_AddressBook_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _AddressBookService_0_4:import3.AddressBookService;
  _AddressBook_0_5:import4.AddressBook;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('address-book',rootSelector,(null as any));
    ...
    compView_0.create(this._AddressBook_0_5,this.projectableNodes,(null as any));
    this.init([].concat([this._el_0]),[this._el_0],[],[]);
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.AddressBookService) && (0 === requestNodeIndex))) { return this._AddressBookService_0_4; }
    if (((token === import4.AddressBook) && (0 === requestNodeIndex))) { return this._AddressBook_0_5; }
    return notFoundResult;
  }
}
function viewFactory_AddressBook_Host0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_AddressBook_Host === (null as any))) { (renderType_AddressBook_Host = viewUtils.createRenderComponentType('',0,import11.ViewEncapsulation.None,[],{})); }
  return new _View_AddressBook_Host0(viewUtils,parentInjector,declarationEl);
}
export const AddressBookNgFactory:import12.ComponentFactory<import4.AddressBook> = new import12.ComponentFactory<import4.AddressBook>('address-book',viewFactory_AddressBook_Host0,import4.AddressBook);
const styles_AddressBook:any[] = [];
var renderType_AddressBook:import0.RenderComponentType = (null as any);
class _View_AddressBook0 extends import1.AppView<import4.AddressBook> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  _text_3:any;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_8 = this.renderer.createElement(this._el_0,'table',(null as any));
    this.renderer.setElementAttribute(this._el_8,'class','table');
    this._text_9 = this.renderer.createText(this._el_8,'\n        ',(null as any));
    this._el_10 = this.renderer.createElement(this._el_8,'tbody',(null as any));
    ...
    this._el_15 = this.renderer.createElement(parentRenderNode,'h4',(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    changes = (null as any);
    const currVal_1:any = this.context.result.people;
...
export function viewFactory_AddressBook0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<import4.AddressBook> {
  if ((renderType_AddressBook === (null as any))) { (renderType_AddressBook = viewUtils.createRenderComponentType('/Users/tor/Development/angular-2-samples/components/dependency-injection/address-book.html',0,import11.ViewEncapsulation.None,styles_AddressBook,{})); }
...
class _View_AddressBook1 extends import1.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_1:any = import5.interpolate(1,'',this.context.$implicit.address,'');
    if (import5.checkBinding(throwOnChange,this._expr_1,currVal_1)) {
...
function viewFactory_AddressBook1(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
