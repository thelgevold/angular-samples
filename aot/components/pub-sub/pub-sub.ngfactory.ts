...
var renderType_PubSub_Host:import0.RenderComponentType = (null as any);
class _View_PubSub_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _PubSub_0_4:import3.PubSub;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('pub-sub',rootSelector,(null as any));
    ...
    compView_0.create(this._PubSub_0_4,this.projectableNodes,(null as any));
    this.init([].concat([this._el_0]),[this._el_0],[],[]);
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.PubSub) && (0 === requestNodeIndex))) { return this._PubSub_0_4; }
    if (((token === import4.PubSubService) && (0 === requestNodeIndex))) { return this._PubSubService_0_5; }
    return notFoundResult;
  }
}
function viewFactory_PubSub_Host0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_PubSub_Host === (null as any))) { (renderType_PubSub_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,[],{})); }
  return new _View_PubSub_Host0(viewUtils,parentInjector,declarationEl);
}
export const PubSubNgFactory:import10.ComponentFactory<import3.PubSub> = new import10.ComponentFactory<import3.PubSub>('pub-sub',viewFactory_PubSub_Host0,import3.PubSub);
const styles_PubSub:any[] = [];
var renderType_PubSub:import0.RenderComponentType = (null as any);
class _View_PubSub0 extends import1.AppView<import3.PubSub> {
  _el_0:any;
  _text_1:any;
  _text_2:any;
  _el_3:any;
  /*private*/ _appEl_3:import2.AppElement;
  _Producer_3_4:import11.Producer;
  _text_4:any;
  _el_5:any;
  _el_6:any;
  _text_7:any;
  ...
  _Consumer_8_4:import12.Consumer;
  _text_9:any;
  _el_10:any;
  _el_11:any;
  _text_12:any;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_3 = this.renderer.createElement(parentRenderNode,'producer',(null as any));
    this._appEl_3 = new import2.AppElement(3,(null as any),this,this._el_3);
    var compView_3:any = import13.viewFactory_Producer0(this.viewUtils,this.injector(3),this._appEl_3);
    ...
    compView_3.create(this._Producer_3_4,[],(null as any));
    this._text_4 = this.renderer.createText(parentRenderNode,'\n\n',(null as any));
    this._el_5 = this.renderer.createElement(parentRenderNode,'br',(null as any));
    this._el_6 = this.renderer.createElement(parentRenderNode,'br',(null as any));
    this._text_7 = this.renderer.createText(parentRenderNode,'\n',(null as any));
    this._el_8 = this.renderer.createElement(parentRenderNode,'consumer',(null as any));
    this._appEl_8 = new import2.AppElement(8,(null as any),this,this._el_8);
    var compView_8:any = import14.viewFactory_Consumer0(this.viewUtils,this.injector(8),this._appEl_8);
    ...
    compView_8.create(this._Consumer_8_4,[],(null as any));
    this._text_9 = this.renderer.createText(parentRenderNode,'\n\n',(null as any));
    this._el_10 = this.renderer.createElement(parentRenderNode,'h4',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import11.Producer) && (3 === requestNodeIndex))) { return this._Producer_3_4; }
    if (((token === import12.Consumer) && (8 === requestNodeIndex))) { return this._Consumer_8_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._Consumer_8_4.ngOnInit(); }
    this.detectContentChildrenChanges(throwOnChange);
    this.detectViewChildrenChanges(throwOnChange);
  }
}
export function viewFactory_PubSub0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import2.AppElement):import1.AppView<import3.PubSub> {
  if ((renderType_PubSub === (null as any))) { (renderType_PubSub = viewUtils.createRenderComponentType('/Users/tor/Development/angular-2-samples/components/pub-sub/pub-sub.html',0,import9.ViewEncapsulation.None,styles_PubSub,{})); }
