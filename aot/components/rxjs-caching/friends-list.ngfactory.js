...
class _View_FriendsList_Host0 extends import1.AppView {
    ...
    createInternal(rootSelector) {
        this._el_0 = import4.selectOrCreateRenderHostElement(this.renderer, 'friends-list', import4.EMPTY_INLINE_ARRAY, rootSelector, null);
...
export const FriendsListNgFactory = new import10.ComponentFactory('friends-list', viewFactory_FriendsList_Host0, import0.FriendsList);
...
class _View_FriendsList0 extends import1.AppView {
    ...
    createInternal(rootSelector) {
        ...
        this._el_3 = import4.createRenderElement(this.renderer, parentRenderNode, 'button', import4.EMPTY_INLINE_ARRAY, null);
...
export function viewFactory_FriendsList0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_FriendsList === null)) {
        (renderType_FriendsList = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, styles_FriendsList, {}));
    }
