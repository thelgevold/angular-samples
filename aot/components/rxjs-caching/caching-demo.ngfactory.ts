...
var renderType_CachingDemo_Host:import2.RenderComponentType = (null as any);
class _View_CachingDemo_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import3.AppElement;
  _FriendsService_0_4:import4.FriendsService;
  _CachingDemo_0_5:Wrapper_CachingDemo;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    this._el_0 = import5.selectOrCreateRenderHostElement(this.renderer,'ng-component',import5.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
    ...
    this._appEl_0.initComponent(this._CachingDemo_0_5.context,([] as any[]),compView_0);
    compView_0.create(this._CachingDemo_0_5.context,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import4.FriendsService) && (0 === requestNodeIndex))) { return this._FriendsService_0_4; }
    if (((token === import0.CachingDemo) && (0 === requestNodeIndex))) { return this._CachingDemo_0_5.context; }
...
function viewFactory_CachingDemo_Host0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_CachingDemo_Host === (null as any))) { (renderType_CachingDemo_Host = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_CachingDemo_Host0(viewUtils,parentInjector,declarationEl);
}
export const CachingDemoNgFactory:import11.ComponentFactory<import0.CachingDemo> = new import11.ComponentFactory<import0.CachingDemo>('ng-component',viewFactory_CachingDemo_Host0,import0.CachingDemo);
const styles_CachingDemo:any[] = ([] as any[]);
var renderType_CachingDemo:import2.RenderComponentType = (null as any);
class _View_CachingDemo0 extends import1.AppView<import0.CachingDemo> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  _text_3:any;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._el_2 = import5.createRenderElement(this.renderer,this._el_0,'button',import5.EMPTY_INLINE_ARRAY,(null as any));
    this._text_3 = this.renderer.createText(this._el_2,'Clear Cache',(null as any));
    this._text_4 = this.renderer.createText(this._el_0,'\n  ',(null as any));
    this._el_5 = import5.createRenderElement(this.renderer,this._el_0,'button',import5.EMPTY_INLINE_ARRAY,(null as any));
    this._text_6 = this.renderer.createText(this._el_5,'Reset',(null as any));
    this._text_7 = this.renderer.createText(this._el_0,'\n',(null as any));
    this._text_8 = this.renderer.createText(parentRenderNode,'\n\n',(null as any));
    this._el_9 = import5.createRenderElement(this.renderer,parentRenderNode,'table',import5.EMPTY_INLINE_ARRAY,(null as any));
    this._text_10 = this.renderer.createText(this._el_9,'\n    ',(null as any));
    this._el_11 = import5.createRenderElement(this.renderer,this._el_9,'tbody',import5.EMPTY_INLINE_ARRAY,(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import14.NgIf) && (14 === requestNodeIndex))) { return this._NgIf_14_6.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
  ...
  private _handle_click_2_0($event:any):boolean {
    ...
    const pd_2_0:any = ((<any>this.context.clearCache()) !== false);
    return (true && pd_2_0);
  }
  private _handle_click_5_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_5_0:any = ((<any>this.context.reset()) !== false);
    return (true && pd_5_0);
  }
}
export function viewFactory_CachingDemo0(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import3.AppElement):import1.AppView<import0.CachingDemo> {
  if ((renderType_CachingDemo === (null as any))) { (renderType_CachingDemo = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,styles_CachingDemo,{})); }
...
class _View_CachingDemo1 extends import1.AppView<any> {
  ...
  _FriendsList_7_4:import15.Wrapper_FriendsList;
  _text_8:any;
  _el_9:any;
  _text_10:any;
  _text_11:any;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._el_4 = import5.createRenderElement(this.renderer,this._el_2,'h2',import5.EMPTY_INLINE_ARRAY,(null as any));
    this._text_5 = this.renderer.createText(this._el_4,'Friends 1',(null as any));
    this._text_6 = this.renderer.createText(this._el_2,'\n            ',(null as any));
    this._el_7 = import5.createRenderElement(this.renderer,this._el_2,'friends-list',import5.EMPTY_INLINE_ARRAY,(null as any));
    ...
    this._appEl_7.initComponent(this._FriendsList_7_4.context,([] as any[]),compView_7);
    compView_7.create(this._FriendsList_7_4.context,([] as any[]),(null as any));
    this._text_8 = this.renderer.createText(this._el_2,'\n            ',(null as any));
    this._el_9 = import5.createRenderElement(this.renderer,this._el_2,'button',import5.EMPTY_INLINE_ARRAY,(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import16.FriendsList) && (7 === requestNodeIndex))) { return this._FriendsList_7_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
  ...
  private _handle_click_9_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_9_0:any = ((<any>this.parent.context.remove('first')) !== false);
    return (true && pd_9_0);
  }
}
function viewFactory_CachingDemo1(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
...
class _View_CachingDemo2 extends import1.AppView<any> {
  ...
  private _handle_click_9_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_9_0:any = ((<any>this.parent.context.remove('second')) !== false);
    return (true && pd_9_0);
  }
}
function viewFactory_CachingDemo2(viewUtils:import5.ViewUtils,parentInjector:import6.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
