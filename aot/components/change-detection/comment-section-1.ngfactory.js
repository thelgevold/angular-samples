...
class _View_CommentSection1_Host0 extends import1.AppView {
    ...
    createInternal(rootSelector) {
        this._el_0 = import4.selectOrCreateRenderHostElement(this.renderer, 'comment-section-1', import4.EMPTY_INLINE_ARRAY, rootSelector, null);
...
export const CommentSection1NgFactory = new import9.ComponentFactory('comment-section-1', viewFactory_CommentSection1_Host0, import0.CommentSection1);
...
export function viewFactory_CommentSection10(viewUtils, parentInjector, declarationEl) {
    if ((renderType_CommentSection1 === null)) {
        (renderType_CommentSection1 = viewUtils.createRenderComponentType('', 0, import8.ViewEncapsulation.None, styles_CommentSection1, {}));
    }
