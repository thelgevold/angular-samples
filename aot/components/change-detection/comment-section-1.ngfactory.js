...
var renderType_CommentSection1_Host = import3.createRenderComponentType('', 0, import4.ViewEncapsulation.None, [], {});
class View_CommentSection1_Host0 extends import1.AppView {
    ...
    createInternal(rootSelector) {
        this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer, 'comment-section-1', import3.EMPTY_INLINE_ARRAY, rootSelector, null);
        ...
        return new import7.ComponentRef_(0, this, this._el_0, this._CommentSection1_0_3.context);
    }
    injectorGetInternal(token, requestNodeIndex, notFoundResult) {
        if (((token === import0.CommentSection1) && (0 === requestNodeIndex))) {
            return this._CommentSection1_0_3.context;
        }
        return notFoundResult;
    }
    detectChangesInternal(throwOnChange) {
        if (this._CommentSection1_0_3.ngDoCheck(this, this._el_0, throwOnChange)) {
...
export const CommentSection1NgFactory = new import7.ComponentFactory('comment-section-1', View_CommentSection1_Host0, import0.CommentSection1);
const styles_CommentSection1 = [];
var renderType_CommentSection1 = import3.createRenderComponentType('', 0, import4.ViewEncapsulation.None, styles_CommentSection1, {});
export class View_CommentSection10 extends import1.AppView {
    constructor(viewUtils, parentView, parentIndex, parentElement) {
    ...
    createEmbeddedViewInternal(nodeIndex) {
        if ((nodeIndex == 34)) {
            return new View_CommentSection11(this.viewUtils, this, 34, this._anchor_34, this._vc_34);
        }
        return null;
    }
...
class View_CommentSection11 extends import1.AppView {
