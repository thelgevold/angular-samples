...
var renderType_RxJsBuffering_Host:import2.RenderComponentType = (null as any);
class _View_RxJsBuffering_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import3.AppElement;
  _RxJsBuffering_0_4:Wrapper_RxJsBuffering;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._appEl_0.initComponent(this._RxJsBuffering_0_4.context,([] as any[]),compView_0);
    compView_0.create(this._RxJsBuffering_0_4.context,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.RxJsBuffering) && (0 === requestNodeIndex))) { return this._RxJsBuffering_0_4.context; }
...
function viewFactory_RxJsBuffering_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_RxJsBuffering_Host === (null as any))) { (renderType_RxJsBuffering_Host = viewUtils.createRenderComponentType('',0,import8.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_RxJsBuffering_Host0(viewUtils,parentInjector,declarationEl);
}
export const RxJsBufferingNgFactory:import9.ComponentFactory<import0.RxJsBuffering> = new import9.ComponentFactory<import0.RxJsBuffering>('ng-component',viewFactory_RxJsBuffering_Host0,import0.RxJsBuffering);
const styles_RxJsBuffering:any[] = ([] as any[]);
var renderType_RxJsBuffering:import2.RenderComponentType = (null as any);
class _View_RxJsBuffering0 extends import1.AppView<import0.RxJsBuffering> {
  _text_0:any;
  _el_1:any;
  _text_2:any;
  _text_3:any;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._el_1 = import4.createRenderElement(this.renderer,parentRenderNode,'h3',import4.EMPTY_INLINE_ARRAY,(null as any));
    ...
    this._appEl_6 = new import3.AppElement(6,(null as any),this,this._anchor_6);
...
export function viewFactory_RxJsBuffering0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<import0.RxJsBuffering> {
  if ((renderType_RxJsBuffering === (null as any))) { (renderType_RxJsBuffering = viewUtils.createRenderComponentType('',0,import8.ViewEncapsulation.None,styles_RxJsBuffering,{})); }
...
class _View_RxJsBuffering1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    this._el_0 = import4.createRenderElement(this.renderer,(null as any),'div',new import4.InlineArray2(2,'class','box'),(null as any));
  ...
  private _handle_click_0_0($event:any):boolean {
    ...
    const pd_0_0:any = ((<any>this.parent.context.add(this.context.$implicit)) !== false);
    return (true && pd_0_0);
  }
}
function viewFactory_RxJsBuffering1(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
...
class _View_RxJsBuffering2 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    this._el_0 = import4.createRenderElement(this.renderer,(null as any),'div',new import4.InlineArray2(2,'class','sum'),(null as any));
    this._text_1 = this.renderer.createText(this._el_0,'',(null as any));
    this.init(([] as any[]).concat([this._el_0]),[
      this._el_0,
      this._text_1
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_2:any = import4.interpolate(1,'SUM: ',this.parent.context.calculation.sum,'');
    if (import4.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this.renderer.setText(this._text_1,currVal_2);
      this._expr_2 = currVal_2;
    }
...
function viewFactory_RxJsBuffering2(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
