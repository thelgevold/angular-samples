...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __AddressBookTitleService_52:import32.AddressBookTitleService;
  __TRANSLATIONS_FORMAT_53:any;
  ...
  get _APP_ID_18():any {
    if ((this.__APP_ID_18 == (null as any))) { (this.__APP_ID_18 = import63._appIdRandomProviderFactory()); }
  ...
  get _EventManager_22():import15.EventManager {
    if ((this.__EventManager_22 == (null as any))) { (this.__EventManager_22 = new import15.EventManager(this._EVENT_MANAGER_PLUGINS_21,this.parent.get(import66.NgZone))); }
  ...
  get _RootRenderer_26():any {
    if ((this.__RootRenderer_26 == (null as any))) { (this.__RootRenderer_26 = import67._createConditionalRootRenderer(this._DomRootRenderer_25,this.parent.get(import67.NgProbeToken,(null as any)))); }
  ...
  get _LocationStrategy_42():import27.HashLocationStrategy {
    if ((this.__LocationStrategy_42 == (null as any))) { (this.__LocationStrategy_42 = new import27.HashLocationStrategy(this.parent.get(import68.PlatformLocation),this.parent.get(import69.APP_BASE_HREF,(null as any)))); }
    return this.__LocationStrategy_42;
  }
  get _Location_43():import28.Location {
    if ((this.__Location_43 == (null as any))) { (this.__Location_43 = new import28.Location(this._LocationStrategy_42)); }
    return this.__Location_43;
  }
  get _UrlSerializer_44():import29.DefaultUrlSerializer {
    if ((this.__UrlSerializer_44 == (null as any))) { (this.__UrlSerializer_44 = new import29.DefaultUrlSerializer()); }
    return this.__UrlSerializer_44;
  }
  get _RouterOutletMap_45():import30.RouterOutletMap {
    if ((this.__RouterOutletMap_45 == (null as any))) { (this.__RouterOutletMap_45 = new import30.RouterOutletMap()); }
    return this.__RouterOutletMap_45;
  }
  get _NgModuleFactoryLoader_46():import31.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_46 == (null as any))) { (this.__NgModuleFactoryLoader_46 = new import31.SystemJsNgModuleLoader(this._Compiler_17,this.parent.get(import31.SystemJsNgModuleLoaderConfig,(null as any)))); }
  ...
  get _ROUTER_CONFIGURATION_48():any {
    if ((this.__ROUTER_CONFIGURATION_48 == (null as any))) { (this.__ROUTER_CONFIGURATION_48 = {}); }
    return this.__ROUTER_CONFIGURATION_48;
  }
  get _Router_49():any {
    if ((this.__Router_49 == (null as any))) { (this.__Router_49 = import7.setupRouter(this._ApplicationRef_16,this._UrlSerializer_44,this._RouterOutletMap_45,this._Location_43,this,this._NgModuleFactoryLoader_46,this._Compiler_17,this._ROUTES_47,this._ROUTER_CONFIGURATION_48)); }
  ...
  get _APP_BOOTSTRAP_LISTENER_51():any[] {
    if ((this.__APP_BOOTSTRAP_LISTENER_51 == (null as any))) { (this.__APP_BOOTSTRAP_LISTENER_51 = [import7.initialRouterNavigation(this._Router_49,this._ROUTER_CONFIGURATION_48)]); }
    return this.__APP_BOOTSTRAP_LISTENER_51;
  }
  get _AddressBookTitleService_52():import32.AddressBookTitleService {
    if ((this.__AddressBookTitleService_52 == (null as any))) { (this.__AddressBookTitleService_52 = new import32.AddressBookTitleService()); }
    return this.__AddressBookTitleService_52;
  }
  get _TRANSLATIONS_FORMAT_53():any {
    if ((this.__TRANSLATIONS_FORMAT_53 == (null as any))) { (this.__TRANSLATIONS_FORMAT_53 = (null as any)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_5 = import7.provideForRootGuard(this.parent.get(import97.Router,(null as any)));
    ...
    this._ApplicationRef__15 = new import12.ApplicationRef_(this.parent.get(import66.NgZone),this.parent.get(import98.Console),this,this._ErrorHandler_12,this,this._ApplicationInitStatus_13,this.parent.get(import11.TestabilityRegistry,(null as any)),this._Testability_14);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import99.LOCALE_ID)) { return this._LOCALE_ID_10; }
    if ((token === import9.NgLocalization)) { return this._NgLocalization_11; }
    if ((token === import100.ErrorHandler)) { return this._ErrorHandler_12; }
    ...
    if ((token === import63.APP_ID)) { return this._APP_ID_18; }
    if ((token === import101.DOCUMENT)) { return this._DOCUMENT_19; }
    ...
    if ((token === import102.AnimationDriver)) { return this._AnimationDriver_24; }
    if ((token === import17.DomRootRenderer)) { return this._DomRootRenderer_25; }
    if ((token === import103.RootRenderer)) { return this._RootRenderer_26; }
    if ((token === import18.DomSanitizer)) { return this._DomSanitizer_27; }
    if ((token === import104.Sanitizer)) { return this._Sanitizer_28; }
    if ((token === import19.ViewUtils)) { return this._ViewUtils_29; }
    if ((token === import105.IterableDiffers)) { return this._IterableDiffers_30; }
    if ((token === import106.KeyValueDiffers)) { return this._KeyValueDiffers_31; }
    ...
    if ((token === import107.XSRFStrategy)) { return this._XSRFStrategy_38; }
    if ((token === import25.XHRBackend)) { return this._XHRBackend_39; }
    if ((token === import26.RequestOptions)) { return this._RequestOptions_40; }
    if ((token === import108.Http)) { return this._Http_41; }
    if ((token === import69.LocationStrategy)) { return this._LocationStrategy_42; }
    ...
    if ((token === import109.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_46; }
    if ((token === import110.ROUTES)) { return this._ROUTES_47; }
    if ((token === import7.ROUTER_CONFIGURATION)) { return this._ROUTER_CONFIGURATION_48; }
    if ((token === import97.Router)) { return this._Router_49; }
    if ((token === import111.ActivatedRoute)) { return this._ActivatedRoute_50; }
    if ((token === import63.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_51; }
    if ((token === import32.AddressBookTitleService)) { return this._AddressBookTitleService_52; }
    if ((token === import112.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_53; }
