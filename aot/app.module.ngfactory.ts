...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __AddressBookTitleService_56:import33.AddressBookTitleService;
  ...
  get _APP_ID_18():any {
    if ((this.__APP_ID_18 == (null as any))) { (this.__APP_ID_18 = import64._appIdRandomProviderFactory()); }
  ...
  get _EventManager_22():import15.EventManager {
    if ((this.__EventManager_22 == (null as any))) { (this.__EventManager_22 = new import15.EventManager(this._EVENT_MANAGER_PLUGINS_21,this.parent.get(import67.NgZone))); }
  ...
  get _RootRenderer_26():any {
    if ((this.__RootRenderer_26 == (null as any))) { (this.__RootRenderer_26 = import68._createConditionalRootRenderer(this._DomRootRenderer_25,this.parent.get(import68.NgProbeToken,(null as any)))); }
  ...
  get _LocationStrategy_42():import27.HashLocationStrategy {
    if ((this.__LocationStrategy_42 == (null as any))) { (this.__LocationStrategy_42 = new import27.HashLocationStrategy(this.parent.get(import69.PlatformLocation),this.parent.get(import70.APP_BASE_HREF,(null as any)))); }
  ...
  get _Router_49():any {
    if ((this.__Router_49 == (null as any))) { (this.__Router_49 = import7.setupRouter(this._ApplicationRef_16,this._UrlSerializer_44,this._RouterOutletMap_45,this._Location_43,this,this._NgModuleFactoryLoader_46,this._Compiler_17,this._ROUTES_47,this._ROUTER_CONFIGURATION_48,this.parent.get(import98.UrlHandlingStrategy,(null as any)))); }
  ...
  get _APP_BOOTSTRAP_LISTENER_55():any[] {
    if ((this.__APP_BOOTSTRAP_LISTENER_55 == (null as any))) { (this.__APP_BOOTSTRAP_LISTENER_55 = [import7.initialRouterNavigation(this._Router_49,this._ApplicationRef_16,this._RouterPreloader_53,this._ROUTER_CONFIGURATION_48)]); }
    return this.__APP_BOOTSTRAP_LISTENER_55;
  }
  get _AddressBookTitleService_56():import33.AddressBookTitleService {
    if ((this.__AddressBookTitleService_56 == (null as any))) { (this.__AddressBookTitleService_56 = new import33.AddressBookTitleService()); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_5 = import7.provideForRootGuard(this.parent.get(import99.Router,(null as any)));
    ...
    this._ApplicationRef__15 = new import12.ApplicationRef_(this.parent.get(import67.NgZone),this.parent.get(import100.Console),this,this._ErrorHandler_12,this,this._ApplicationInitStatus_13,this.parent.get(import11.TestabilityRegistry,(null as any)),this._Testability_14);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import64.APP_ID)) { return this._APP_ID_18; }
    if ((token === import103.DOCUMENT)) { return this._DOCUMENT_19; }
    ...
    if ((token === import104.AnimationDriver)) { return this._AnimationDriver_24; }
    if ((token === import17.DomRootRenderer)) { return this._DomRootRenderer_25; }
    if ((token === import105.RootRenderer)) { return this._RootRenderer_26; }
    if ((token === import18.DomSanitizer)) { return this._DomSanitizer_27; }
    if ((token === import106.Sanitizer)) { return this._Sanitizer_28; }
    if ((token === import19.ViewUtils)) { return this._ViewUtils_29; }
    if ((token === import107.IterableDiffers)) { return this._IterableDiffers_30; }
    if ((token === import108.KeyValueDiffers)) { return this._KeyValueDiffers_31; }
    ...
    if ((token === import109.XSRFStrategy)) { return this._XSRFStrategy_38; }
    if ((token === import25.XHRBackend)) { return this._XHRBackend_39; }
    if ((token === import26.RequestOptions)) { return this._RequestOptions_40; }
    if ((token === import110.Http)) { return this._Http_41; }
    if ((token === import70.LocationStrategy)) { return this._LocationStrategy_42; }
    ...
    if ((token === import111.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_46; }
    if ((token === import112.ROUTES)) { return this._ROUTES_47; }
    if ((token === import7.ROUTER_CONFIGURATION)) { return this._ROUTER_CONFIGURATION_48; }
    if ((token === import99.Router)) { return this._Router_49; }
    if ((token === import113.ActivatedRoute)) { return this._ActivatedRoute_50; }
    ...
    if ((token === import64.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_55; }
    if ((token === import33.AddressBookTitleService)) { return this._AddressBookTitleService_56; }
