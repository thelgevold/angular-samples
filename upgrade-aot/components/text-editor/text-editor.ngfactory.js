...
export var Wrapper_TextEditor = (function () {
    ...
    Wrapper_TextEditor.prototype.ngOnDetach = function (view, componentView, el) {
    };
    Wrapper_TextEditor.prototype.ngOnDestroy = function () {
    };
    Wrapper_TextEditor.prototype.ngDoCheck = function (view, el, throwOnChange) {
    ...
    Wrapper_TextEditor.prototype.checkHost = function (view, componentView, el, throwOnChange) {
    };
    Wrapper_TextEditor.prototype.handleEvent = function (eventName, $event) {
        var result = true;
        return result;
    };
    Wrapper_TextEditor.prototype.subscribe = function (view, _eventHandler) {
...
var View_TextEditor_Host0 = (function (_super) {
    __extends(View_TextEditor_Host0, _super);
    function View_TextEditor_Host0(viewUtils, parentView, parentIndex, parentElement) {
        _super.call(this, View_TextEditor_Host0, renderType_TextEditor_Host, import5.ViewType.HOST, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckAlways);
    }
    View_TextEditor_Host0.prototype.createInternal = function (rootSelector) {
    ...
    View_TextEditor_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.TextEditor) && (0 === requestNodeIndex))) {
            return this._TextEditor_0_3.context;
        }
        return notFoundResult;
    };
    View_TextEditor_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._TextEditor_0_3.ngDoCheck(this, this._el_0, throwOnChange);
        this.compView_0.detectChanges(throwOnChange);
    };
    View_TextEditor_Host0.prototype.destroyInternal = function () {
        this.compView_0.destroy();
    };
    View_TextEditor_Host0.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._el_0, ctx);
    };
    return View_TextEditor_Host0;
}(import1.AppView));
export var TextEditorNgFactory = new import7.ComponentFactory('editor', View_TextEditor_Host0, import0.TextEditor);
...
export var View_TextEditor0 = (function (_super) {
    __extends(View_TextEditor0, _super);
    function View_TextEditor0(viewUtils, parentView, parentIndex, parentElement) {
        _super.call(this, View_TextEditor0, renderType_TextEditor, import5.ViewType.COMPONENT, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckAlways);
    }
    View_TextEditor0.prototype.createInternal = function (rootSelector) {
    ...
    View_TextEditor0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    View_TextEditor0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    View_TextEditor0.prototype.destroyInternal = function () {
        this._vc_10.destroyNestedViews();
    };
    View_TextEditor0.prototype.createEmbeddedViewInternal = function (nodeIndex) {
        if ((nodeIndex == 10)) {
            return new View_TextEditor1(this.viewUtils, this, 10, this._anchor_10, this._vc_10);
        }
        return null;
    };
    return View_TextEditor0;
}(import1.AppView));
var View_TextEditor1 = (function (_super) {
    __extends(View_TextEditor1, _super);
    function View_TextEditor1(viewUtils, parentView, parentIndex, parentElement, declaredViewContainer) {
        _super.call(this, View_TextEditor1, renderType_TextEditor, import5.ViewType.EMBEDDED, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckAlways, declaredViewContainer);
    ...
    View_TextEditor1.prototype.createInternal = function (rootSelector) {
    ...
    View_TextEditor1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import17.NgClass) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._NgClass_0_3.context;
        }
        return notFoundResult;
    };
    View_TextEditor1.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    View_TextEditor1.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._el_0, ctx);
    };
    return View_TextEditor1;
}(import1.AppView));
